...
<script type="text/javascript" src="../js/var.js?var=1.7"></script>
<script>
	...
	function openConfirmnick(userinput) {
		...
		url = "/FORKI/content/join/factor/user/confirmNick.do?nickname="
				+ userinput.nickname.value;
...
<body>
	<form method="post" action="/FORKI/content/join/UserModifyPro.do" name="userinput" onSubmit="return checkIt()">
		...
		<table id="mytable" width="400" border="1" cellspacing="0"
			...
			<tr>
				<td height="39" align="center" colspan="4"><font size="+1"><b>회원
							정보수정</b></font></td>
			</tr>

			<tr>
				<td width="400" colspan="4">${id}</td>
			</tr>
       ...
       <b>비밀번호를 동일하게 입력하세요. /필수 정보입니다.</b>
			...
			<tr>
				<td colspan="4"><font size="1" color="red"> <b>/필수
							정보입니다.</b>
				</font></td>
			</tr>
			...
			<tr>
				<td colspan="4"><b>생년월일</b></td>
			</tr>

			<tr>
				<td colspan="4"><input type="text" name="b_day" size="10"
					maxlength="8" readonly value="${b_day}"> <%-- <select name="MM" id="month">
        <%for(int i=1; i<13; i++){  %>
...
<tr>
        ...
        <tr class="item1"> 
			...
			<c:forEach var="i" items="${klist}">
				...
				<tr><input type="hidden" name="count">
				<td><input type="text" name="kidName${i.child_num}" value="${i.child_name}"></td>
            	<td><input type="text" name="kinderName${i.child_num}" value="${i.schul_nm}"></td>
            	<td><input type="button" onClick="SchulCheck(${i.child_num})" value="유치원검색"></td>
            	</tr>
            	<script>
            		listSize = ${i.child_num};
            	</script>
