...
/* $(document).ready(function(){
	...
	function boxresetSCHUL_NUM() {
    	var userinput = eval("document.userinput");
    	if(userinput.schul_num.value=="사업자번호"){
    		userinput.schul_num.value="";
    	}
    	
	}
	
	function boxresetSCHUL_NM() {
    	var userinput = eval("document.userinput");
    	if(userinput.schul_nm.value=="어린이집/유치원 명"){
    		userinput.schul_nm.value="";
    	}
