				...
				<form>
					<fieldset>
						...
						<div class="seoulMap">
							...
							<map name="seoulMap">
								<area alt="종로구_23" onmouseover="mouseOverMap('300');"
									shape="poly"
								...
								<area alt="중구_25" onmouseover="mouseOverMap('301');"
									shape="poly"
								...
								<area alt="용산구_21" onmouseover="mouseOverMap('302');"
									shape="poly"
								...
								<area alt="성동구_16" onmouseover="mouseOverMap('303');"
									shape="poly"
								...
								<area alt="광진구_6" onmouseover="mouseOverMap('304');"
									shape="poly"
								...
								<area alt="동대문구_11" onmouseover="mouseOverMap('305');"
									shape="poly"
								...
								<area alt="중랑구_24" onmouseover="mouseOverMap('306');"
									shape="poly"
								...
								<area alt="성북구_17" onmouseover="mouseOverMap('307');"
									shape="poly"
								...
								<area alt="강북구_3" onmouseover="mouseOverMap('308');"
									shape="poly"
								...
								<area alt="도봉구_10" onmouseover="mouseOverMap('309');"
									shape="poly"
								...
								<area alt="노원구_9" onmouseover="mouseOverMap('310');"
									shape="poly"
								...
								<area alt="은평구_22" onmouseover="mouseOverMap('311');"
									shape="poly"
								...
								<area alt="서대문구_14" onmouseover="mouseOverMap('312');"
									shape="poly"
								...
								<area alt="마포구_13" onmouseover="mouseOverMap('313');"
									shape="poly"
								...
								<area alt="양천구_19" onmouseover="mouseOverMap('314');"
									shape="poly"
								...
								<area alt="강서구_4" onmouseover="mouseOverMap('315');"
									shape="poly"
								...
								<area alt="구로구_7" onmouseover="mouseOverMap('316');"
									shape="poly"
								...
								<area alt="금천구_8" onmouseover="mouseOverMap('317');"
									shape="poly"
								...
								<area alt="영등포구_20" onmouseover="mouseOverMap('318');"
									shape="poly"
								...
								<area alt="동작구_12" onmouseover="mouseOverMap('319');"
									shape="poly"
								...
								<area alt="관악구_5" onmouseover="mouseOverMap('320');"
									shape="poly"
								...
								<area alt="서초구_15" onmouseover="mouseOverMap('321');"
									shape="poly"
								...
								<area alt="강남구_1" onmouseover="mouseOverMap('322');"
									shape="poly"
								...
								<area alt="송파구_18" onmouseover="mouseOverMap('323');"
									shape="poly"
								...
								<area alt="강동구_2" onmouseover="mouseOverMap('324');"
									shape="poly"
