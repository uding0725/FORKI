...
<table id="board">
	<tr>
		<td colspan="5" style="text-align:center;"><b>글목록(전체 글:)</b></td>
	</tr>
	<tr>
    	<td colspan="5" style="text-align:right;"> 
    		<a style="text-decoration: none;" href="freeBoardWrite.jsp">글쓰기</a> 
    	</td>
	</tr>
...
<%-- <%  } else {    %> --%>
    ...
    <tr id="index">
      <td style="width:50;">번 호</td>
      <td style="width:400;">제   목</td>
      <td style="width:100;">닉네임</td>
      <td style="width:150;">조회수</td>
      <td style="width:50;">등록일</td>
    </tr>
    <tr>
    	<td colspan="5">
    		=======================게시글 리스트가 들어갈 자리임다.======================<br>
    		=======================게시글 리스트가 들어갈 자리임다.======================<br>
    		=======================게시글 리스트가 들어갈 자리임다.======================<br>
    		=======================게시글 리스트가 들어갈 자리임다.======================<br>
    		=======================게시글 리스트가 들어갈 자리임다.======================<br>
