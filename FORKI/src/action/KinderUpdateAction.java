...
public class KinderUpdateAction implements CommandAction{
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable{
		...
		kdata.setZip(request.getParameter("zip"));
		kdata.setAdres(request.getParameter("adres"));
